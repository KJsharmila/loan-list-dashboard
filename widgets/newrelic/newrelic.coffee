class Dashing.Newrelic extends Dashing.Widget
  ...
  onData: (data) ->
    ...
    @responseGreen = document.getElementById(this.id).getAttribute('data-purple')
    @responseYellow = document.getElementById(this.id).getAttribute('data-purple')
    ...
    if (
      ...
      $('#' + this.id + '.widget-newrelic').css('background-color', '#333A52')
